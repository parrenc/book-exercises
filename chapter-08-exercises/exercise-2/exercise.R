...
sentence <- tolower("hello world! hello world the second time")
...
count_occurrence <- function(letter, letter_vector){
length(letter_vector[letter_vector == letter])
}
...
frequencies <- as.list(sapply(unique, count_occurrence, letters))
